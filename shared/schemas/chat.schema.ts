import { z } from "zod"; // schema declaration and validation library
...
export const RoomNameSchemaRegex = new RegExp("^\\S+\\w$"); // Room name should start with non-whitespaces characters
...
// user object
// we only really need to add the socketId
